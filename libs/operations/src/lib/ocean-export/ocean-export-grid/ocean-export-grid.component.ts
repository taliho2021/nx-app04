...
@Component({
  selector: 'nx-app04-ocean-export-grid',
  standalone: true,
  imports: [CommonModule, AgGridModule],
  templateUrl: './ocean-export-grid.component.html',
  styleUrls: ['./ocean-export-grid.component.scss'],
})
export class OceanExportGridComponent {
  columnDefs: ColDef[] = [
    {
      field: 'refNo',
      sortable: true,
