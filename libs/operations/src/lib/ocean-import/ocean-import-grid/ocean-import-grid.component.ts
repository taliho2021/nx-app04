...
@Component({
  selector: 'nx-app04-ocean-import-grid',
  standalone: true,
  imports: [CommonModule, AgGridModule],
  templateUrl: './ocean-import-grid.component.html',
  styleUrls: ['./ocean-import-grid.component.scss'],
})
export class OceanImportGridComponent {
  columnDefs: ColDef[] = [
    {
      field: 'refNo',
      sortable: true,
